...
import com.emprovise.soapui.util.AnnotationFactory;
...
public class WsdlDocument {
	...
	private void initWsdl4j() throws WSDLException {
		...
		WSDLReader wsdlReader = wfactory.newWSDLReader();
		wsdlReader.setFeature("javax.wsdl.verbose", true);
		wsdlReader.setFeature("javax.wsdl.importDocuments", true);
		UrlWsdlLoader urlWsdlLoader = new UrlWsdlLoader(wsdlUrl.toString());
		wsdlObject = wsdlReader.readWSDL(urlWsdlLoader);
	}
	...
	protected WsdlMockService createMockService(String serviceName) {
		return project.addNewMockService(serviceName);
	}
}
