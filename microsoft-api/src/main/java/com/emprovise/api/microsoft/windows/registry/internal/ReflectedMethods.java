package com.emprovise.api.microsoft.windows.registry.internal;

import com.emprovise.api.microsoft.windows.registry.HKey;
...
public final class ReflectedMethods {
	...
	private static Method setupMethod(String name, Class<?>[] args) {
		Method method = null;
		try {
			method = HKey.HKEY_CURRENT_USER.root().getClass().getDeclaredMethod(name, args);
		} catch (Exception e) {
